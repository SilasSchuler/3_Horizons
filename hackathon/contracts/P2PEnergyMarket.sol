...
function settleSlot() external nonReentrant {
    ...
    // 7. lastSettledSlot VOR den externen Token-Calls setzen
    //    (Checks-Effects-Interactions). Zusammen mit nonReentrant ist damit
    //    ausgeschlossen, dass ein reentranter Aufruf denselben Slot doppelt
    //    abrechnet.
